...
const transformer = require('./hook-config');
...
//     camel2DashComponentName: false
//   })
	console.log('-----transformer should compile lodash library', transformer);
  ...
  fixtureDir.forEach(v => {
    it(`compile ${v}`, () => {
      ...
      const expectCode = fs.readFileSync(resolve(__dirname, 'expect1', 'lodash', v), 'utf-8')
